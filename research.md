...
This summer, I am researching the political philosophy of technology and society alongside Dr. Hunt. It constitutes only part-time work supplementing a grant I received for full-time CS research, but it has remained incredibly interesting nonetheless—it initially grew out of three essays I wrote for Dr. Hunt's full-year Political & Cultural Change seminar, which he proposed we synthesize into a paper with some additional political philosophy elements. Presently, we are writing up a draft tentatively entitled *The evolution of digital capitalism: a new form of class politics in the algorithmic age*.
